...
public class HomeFragment extends Fragment {
    ...
    // ImageView to display the machine status icon
    private ImageView machineStatusIcon;
    // ImageView to display the motor status icon
    private ImageView motorStatusIcon;

    // Machine Heat Exchange Card UI elements
    private TextView heatExchangeInletText;
    private TextView heatExchangeOutletText;

    // Hydrualic Flow and Pressure Card UI elements
    private TextView hydraulicFlowText;
    private TextView hydraulicPressureText;

    // Power Consumption Card UI elements
    private TextView powerConsumptionText;

    // Temperature Zones Card UI elements
    private TextView zone1Text;
    private TextView zone2Text;
    private TextView zone3Text;
    private TextView zone4Text;

    // Machine Oil Temperature Card UI elements
    private TextView machineOilTempText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        machineStatusIcon = view.findViewById(R.id.machineStatusIcon);
        motorStatusIcon = view.findViewById(R.id.motorStatusIcon);

        // Machine Heat Exchange Card UI elements
        heatExchangeInletText = view.findViewById(R.id.inletTempValue);
        heatExchangeOutletText = view.findViewById(R.id.outletTempValue);

        // Hydrualic Flow and Pressure Card UI elements
        hydraulicFlowText = view.findViewById(R.id.hydraulicFlowValue);
        hydraulicPressureText = view.findViewById(R.id.hydraulicPressureValue);

        // Power Consumption Card UI elements
        powerConsumptionText = view.findViewById(R.id.powerConsumptionValue);

        // Temperature Zones Card UI elements
        zone1Text = view.findViewById(R.id.tempZone1);
        zone2Text = view.findViewById(R.id.tempZone2);
        zone3Text = view.findViewById(R.id.tempZone3);
        zone4Text = view.findViewById(R.id.tempZone4);

        // Machine Oil Temperature Card UI elements
        machineOilTempText = view.findViewById(R.id.machineOilValue);
    ...
    private void handleBasicTemperatures(DataSnapshot snapshot) {
        ...
        // Update the machine oil temperature text
        machineOilTempText.setText((machineOilTemp != null) ? machineOilTemp + "°C" : "Data Not Available");
    }
    ...
    private void handleFlowPressureData(DataSnapshot snapshot) {
        ...
        // Update the hydraulic flow and pressure text
        hydraulicFlowText.setText((hydraulicFlow != null) ? hydraulicFlow + " L/min" : "Data Not Available");
        hydraulicPressureText.setText((hydraulicPressure != null) ? hydraulicPressure + " bar" : "Data Not Available");
    }
    ...
    private void handleHeatExchangeData(DataSnapshot snapshot) {
        ...
        // Update the heat exchange temperature text
        heatExchangeInletText.setText((inletTemp != null) ? inletTemp + "°C" : "Data Not Available");
        heatExchangeOutletText.setText((outletTemp != null) ? outletTemp + "°C" : "Data Not Available");
    }
    ...
    private void handlePositionSensorsData(DataSnapshot snapshot) {
        ...
        Double ejectorPosition = positionSensorsSnapshot.child("ejector_position").getValue(Double.class);
        ...
        addSensorCard("Ejector Position", (ejectorPosition != null) ? ejectorPosition + " mm" : "Data Not Available");
    ...
    private void handlePowerMonitoringData(DataSnapshot snapshot) {
        ...
        addSensorCard("Power Consumption", (powerConsumption != null) ? String.format("%.1f W", powerConsumption) : "Data Not Available");
        ...
        // Update the power consumption text
        powerConsumptionText.setText((powerConsumption != null) ? String.format("%.1f W", powerConsumption) : "Data Not Available");
    }
    ...
    private void handleMachineStatus(DataSnapshot snapshot) {
        ...
        // Update icons for machine and motor states
        if (machineState != null) {
            machineStatusIcon.setImageResource(machineState ? R.drawable.switchon : R.drawable.switchoff);
            motorStatusIcon.setImageResource(motorState != null && motorState ? R.drawable.switchon : R.drawable.switchoff);
        }
    }
    ...
    private void handleTemperatureZonesData(DataSnapshot snapshot) {
        ...
        // Update the temperature zone text
        zone1Text.setText((zone1 != null) ? zone1 + "°C" : "Data Not Available");
        zone2Text.setText((zone2 != null) ? zone2 + "°C" : "Data Not Available");
        zone3Text.setText((zone3 != null) ? zone3 + "°C" : "Data Not Available");
        zone4Text.setText((zone4 != null) ? zone4 + "°C" : "Data Not Available");
    }
